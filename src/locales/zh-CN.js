...
export default {
  ...
  'menu.systemconfig.datadictionary': '数据字典管理',
  'menu.systemconfig.datadictionaryvalue': '数据字典值管理',
  'menu.systemconfig.config': '系统配置管理',
  'menu.organization': '组织机构管理',
  'menu.organization.position': '职位管理',
  'menu.organization.post': '岗位管理',
  'menu.organization.staff': '员工管理',
  'menu.organization.permission': '权限管理',
  'menu.project': '项目管理',
  'menu.project.project_link': '项目环节管理',
  'menu.project.project_task': '项目任务管理',
  'menu.project.project_subtask': '项目子任务管理',
  'menu.integral': '积分管理',
  'menu.integral.earnpoints': '积分获取管理',
  'menu.integral.culturalcontribution': '文化贡献积分管理',
  'menu.integral.totalpoints': '总积分管理',
  'menu.integral.statistics': '积分统计管理',
  'menu.form': '表单页',
