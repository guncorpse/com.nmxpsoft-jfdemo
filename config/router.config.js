  ...
  // app
  {
    ...
    routes: [
      ...
      // { path: '/', redirect: '/dashboard/analysis' },
      {
        ...
        routes: [
          {
            path: '/systemconfig/datadictionary',
            name: 'datadictionary',
            icon: 'dashboard',
            component: './List/TableList',
          },
          {
            path: '/systemconfig/datadictionaryvalue',
            name: 'datadictionaryvalue',
            icon: 'dashboard',
            component: './List/TableList',
          },
          {
            path: '/systemconfig/config',
            name: 'config',
            icon: 'dashboard',
            component: './List/TableList',
          },
